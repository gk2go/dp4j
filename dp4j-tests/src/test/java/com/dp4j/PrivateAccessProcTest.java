...
public class PrivateAccessProcTest {
    ...
    public void mostComprehensiveTest() throws IOException {
        ...
        File targetClasses = getFile(workingdir.getParentFile(), "target", "classes");
        ...
        final String dp4j = getFile(System.getProperty("user.home"), ".m2", "repository", "com", "dp4j", "", "commons-lang-2.6.jar").getAbsolutePath();
    ...
    final static String tests[][] = {
        ...
        {testSrc.getAbsolutePath(), comDp4jSamples, "EqualsTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "CompTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "VarArgsCallTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "CallTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "IfTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "MultipleCallsTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "ForEachTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "ArrayCallTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "PrivateConstructorTest"},
        ...
        {testSrc.getAbsolutePath(), comDp4jSamples, "OverloadTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "InheritedPrivateTest"},
        {testSrc.getAbsolutePath(), comDp4jSamples, "ElseTest"},
